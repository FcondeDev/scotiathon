...
public class VoucherConfiguration {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.scotiathon.voucher")).paths(PathSelectors.any()).build()
				.apiInfo(new ApiInfoBuilder().title("Voucher Service").description("Service to process vouchers")
						.build());
	}
